...
void render_init_color_texture(u32* texture){
    const static u8 solid_white[4] = {255, 255, 255, 255};
...
void render_init_quad(u32* vao, u32* vbo, u32* ebo){
    ...
    //xyz
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(f32), NULL); //It takes 5 floats to get to next new vertex
